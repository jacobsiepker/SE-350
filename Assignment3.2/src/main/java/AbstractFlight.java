...
public class AbstractFlight {
    ...
    protected Date departTime;

    public AbstractFlight(Airline airline, Airport departAirport, Airport arriveAirport, Date departTime) throws Exception {
    ...
    public boolean equals(Object o) {
        ...
        AbstractFlight flight = (AbstractFlight) o;
